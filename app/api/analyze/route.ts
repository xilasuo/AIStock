...
function slimFactsForPrompt(facts: Awaited<ReturnType<typeof analyzeStockData>>) {
  ...
  return {
    ...
    volume: {
      ...
      ratioBasis: "当日成交量/近5日平均成交量(通用量比口径)",
      ma5Note: "派生中间量,非独立均量对比基准",
      ma20Note: "派生中间量,非独立均量对比基准",
        ...
        messages: [
          {
            ...
            content: [
              ...
              "【数字格式硬约束】所有金额、价格、百分比、仓位一律用阿拉伯数字+单位呈现（如 ¥344.96、16.27%、仓位 12.3%），严禁使用中文大写数字（如“叁佰肆拾肆元玖角陆分”“贰拾点壹零百分比”“壹仟股”）；数字直接写在正文，不额外念成中文大写，也不把“%”“元”替换成中文读法。",
              "【量比口径说明】volume.ratio（量比）已是“当日成交量 / 近5日平均成交量”的通用口径；volume.ma5/ma20 仅为派生中间量，禁止把它们当作“近5日均量/近20日均量”拿来做均量对比或二次解读。",
